...
public class Aula09Objetos {
    ...
    public static void main(String[] args) {
      ...
      * e funcionalidades.
      *
      * Eles herdam funções da classe mãe java.lang.Object, é correto  afirmar que java.lang.Object é uma super classe de qualquer outra classe ou tipo abstrato.
      */ 
      Integer numero = 10; //Tipo abstrato
      int numero2 = 10; // Tipo primitivo

      // Retorna se a variavel/calsse é uma instancia de outra classe
